    ...
    <div class="my-shop">
        ...
        <div>
            ...
            <el-row type='flex' justify='center' align='middle'>
                ...
                <el-col :span="20">
                    <el-button v-if='$route.params.id' type="primary" @click="addClick">修改</el-button>
                    <el-button v-else type="primary" @click="addClick">提交</el-button>
                </el-col>
            </el-row>
...
export default {
    ...
    data:function(){
     ...
     mounted() {
        ...
        if(id) {
            // 这是编辑 
            this.$http.getGoodDetail({id}).then(res=>{
                this.info = res
            })
        }
    },
    methods:{
        addClick(){
            ...
            this.$http.getGoodList(data).then(()=>{
                this.$message({
                    message: '恭喜你，商品添加成功',
                    type: 'success'
                })
